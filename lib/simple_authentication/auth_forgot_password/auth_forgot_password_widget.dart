...
class _AuthForgotPasswordWidgetState extends State<AuthForgotPasswordWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'auth_ForgotPassword'});
    if (!isWeb) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'oofgudf5' /* We will send you a reset link. */,
                                ),
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                  ...
                  if (!(isWeb
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'AUTH_FORGOT_PASSWORD_SEND_LINK_BTN_ON_TA');
