...
class _AuthWelcomeScreenWidgetState extends State<AuthWelcomeScreenWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'auth_WelcomeScreen'});
  }
                      ...
                      children: [
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'fuboq56x' /* Personalized Habits Tracker */,
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '9ziyx56n' /* A user-friendly application fo... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'yx2fc802' /*  Manage remainders efficiently... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'AUTH_WELCOME_SCREEN_LOGIN_BTN_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'AUTH_WELCOME_SCREEN_CREATE_AN_ACCOUNT_BT');
                              logFirebaseEvent('Button_navigate_to');

                              context.pushNamed('auth_Create');
                            },
                            text: FFLocalizations.of(context).getText(
                              'q5j953d0' /* Create an Account */,
                            ),
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 60.0,
