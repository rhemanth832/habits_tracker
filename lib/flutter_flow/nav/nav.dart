...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomeWidget() : const AuthWelcomeScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'AskAI',
          path: '/askAI',
          builder: (context, params) => const AskAIWidget(),
        ),
        FFRoute(
          name: 'Home',
          path: '/home',
        ...
        FFRoute(
          name: 'CutsPage',
          path: '/cutsPage',
          builder: (context, params) => const CutsPageWidget(),
        ),
        FFRoute(
          name: 'InspectPage',
          path: '/inspectPage',
          builder: (context, params) => InspectPageWidget(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Your_Habits_Tracker.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
