      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('DONATION_arrow_back_rounded_ICN_ON_TAP');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/Donation_QR_Image.jpg',
                                        width: 300.0,
                                        height: 200.0,
                                        fit: BoxFit.contain,
                                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'DONATION_PAGE_PAGE_CLICK_HERE_BTN_ON_TAP');
                              logFirebaseEvent('Button_launch_u_r_l');
                              await launchURL(
                                  'https://paypal.me/rhemu143?country.x=IN&locale.x=en_GB');
                            },
                            text: FFLocalizations.of(context).getText(
                              'ybchd7ju' /* Click Here */,
                            ),
